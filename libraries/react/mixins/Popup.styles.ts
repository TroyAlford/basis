...
style('basis:popup', css`
  ...
  [data-popup='true'] {
    ...
    &[data-popup-arrow='true'] {
      ...
      &[data-popup-anchor-point='top']::before,
      &[data-popup-anchor-point='bottom']::before {
        left: calc(
          50% - var(--popup-shift-x) -
          (var(--basis-popup-arrow-size) / 2)
        );
      }
      &[data-popup-anchor-point='top-start']::before,
      &[data-popup-anchor-point='bottom-start']::before {
        left: calc(var(--basis-popup-arrow-size) - var(--popup-shift-x));
      }
      &[data-popup-anchor-point='top-end']::before,
      &[data-popup-anchor-point='bottom-end']::before {
      ...
      &[data-popup-anchor-point='left']::before,
      &[data-popup-anchor-point='right']::before {
        top: calc(
          50% - var(--popup-shift-y) -
          (var(--basis-popup-arrow-size) / 2)
        );
      }
      &[data-popup-anchor-point='left-start']::before,
      &[data-popup-anchor-point='right-start']::before {
        top: var(--basis-popup-arrow-size);
      }
      &[data-popup-anchor-point='left-end']::before,
      &[data-popup-anchor-point='right-end']::before {
