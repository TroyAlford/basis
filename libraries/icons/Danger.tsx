...
export class Danger extends IconBase {
  ...
  renderContent = (): React.ReactNode => {
    ...
    const faceMask = this.mask('face', face)
    ...
    return (
      <>
        <defs>{faceMask}</defs>
        {React.cloneElement(outline, { mask: faceMask.props.url })}
        {!filled && face}
      </>
    )
  }
