        ...
        <section>
          ...
          <div style={{ display: 'grid', gap: '2rem', gridTemplateColumns: '300px 1fr' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              ...
              <div>
                <h4>State</h4>
                <Button onActivate={() => void this.handleField(!this.current.open, 'open')}>
                  {this.current.open ? 'Close' : 'Open'} Menu
                </Button>
              </div>
            </div>
            {/* Demo Area */}
            <div style={{ border: '1px solid #ccc', borderRadius: '4px', padding: '2rem', textAlign: 'center' }}>
              <div style={{ display: 'inline-block', position: 'relative' }}>
                <DropdownMenu
                  ...
                  onClose={() => void this.handleField(false, 'open')}
                  onOpen={() => void this.handleField(true, 'open')}
                >
